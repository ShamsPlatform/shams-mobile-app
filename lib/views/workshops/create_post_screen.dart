...
class _CreatePostScreenState extends State<CreatePostScreen> {
        ...
        child: AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              child: Text('المعرض (صور)', style: GoogleFonts.tajawal(color: Colors.blue)),
            ),
            TextButton(
              onPressed: () => _handlePick(ImageSource.gallery, true),
              child: Text('المعرض (فيديو)', style: GoogleFonts.tajawal(color: Colors.purple)),
            ),
            TextButton(
              onPressed: () => _handlePick(ImageSource.camera, false),
              child: Text('الكاميرا', style: GoogleFonts.tajawal(color: Colors.orange)),
            ),
            TextButton(
  ...
  Future<void> _handlePick(ImageSource source, bool isVideo) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("عذراً، الكاميرا أو هذه الميزة قد لا تكون مدعومة على هذا النظام حالياً.")),
      );
    }
  }
  ...
  void _publish() {
    ...
    final newPost = {
      ...
      'timeAgo': 'الآن',
      'viewsCount': '0',
      'imagePath': _attachments.isNotEmpty ? _attachments.first.path : null,
